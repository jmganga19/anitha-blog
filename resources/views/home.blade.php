...
<body>
    ...
    <body>
        ...
        <div class="tm-home-img-container">
            <img src="{{asset('img/tm-home-img.jpg')}}" alt="Image" class="lg-up img-fluid">
        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-xs-center">
                        <h2 class="tm-gold-text tm-title">Karibu</h2>
                        <p class="tm-subtitle">Ni muhimu Sana kila mwanamke na mwanamume waweze kufatilia huduma za Afya kwa usahihi ili waweze kuwa mama na baba Bora kwa watoto wao.</p>
                    </div>
                </div>
                ...
                <div class="row tm-margin-t-big">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="{{url('public/Image/'.$post->image)}}" alt="Image" style="height: 100px; width: 150px;" class="tm-margin-b-20 img-fluid">
                            <h4 class="tm-margin-b-20 tm-gold-text">{{$post->title}}</h4>
                            <label>{{ $post->created_at->format('M j, Y') }}</label>
                            {{-- <p class="tm-margin-b-20">{{$post->body}}</p> --}}

                            <p class="ArticleBody">
                                {{substr(strip_tags($post->description),0,70) }}
                                @if (strlen(strip_tags($post->description)) > 70)
                ...
                <div class="row tm-margin-t-big">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="tm-2-col-left">
                            ...
                            <img src="{{asset('img/women.jpg')}}" alt="Image" class="tm-margin-b-40 img-fluid">
                            <p>
       ...
       <x-footer />
        ...
        <script src="{{asset('assets/js/bootstrap.bundle.min.js')}}"></script>                 <!-- Bootstrap (http://v4-alpha.getbootstrap.com/) -->
