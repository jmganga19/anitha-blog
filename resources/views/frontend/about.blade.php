...
<x-header />
                ...
                <div class="row tm-margin-t-mid">
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="{{asset('img/tm-img-310x180-1.jpg')}}" alt="Image" class="tm-margin-b-30 img-fluid">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="{{asset('img/tm-img-310x180-2.jpg')}}" alt="Image" class="tm-margin-b-30 img-fluid">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="{{asset('img/tm-img-310x180-3.jpg')}}" alt="Image" class="tm-margin-b-30 img-fluid">
       ...
       <x-footer />
        ...
        <script src="{{asset('assets/js/bootstrap.min.js')}}"></script>                 <!-- Bootstrap (http://v4-alpha.getbootstrap.com/) -->
